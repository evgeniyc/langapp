...
fun WordScreen(
    ...
    // Логирование внутри WordScreen, когда wordUiState обновляется
    Log.d("WordScreen", "WordScreen: called")
    Log.d("WordScreen", "WordScreen: wordUiState.words.size = ${wordUiState.words.size}")
    Log.d("WordScreen", "WordScreen: wordUiState.isLoading = ${wordUiState.isLoading}")
